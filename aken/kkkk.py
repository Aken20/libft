...
def check_spaces(game, x, y, _id, _next, K):
    ...
    if x <= w:
        ...
        i = i + 1
        if s_x != -1:
            return SPORER(x, y, _id, i, "E", _next, 9000 - i)
        if l > 3:
    ...
    if x >= w:
        ...
        i = i - 1
        if s_x != -1:
            return SPORER(x, y, _id, i, "W", _next, 9000 + i)
        if l < -3:
    ...
    if y <= h:
        ...
        i = i + 1
        if s_x != -1:
            return SPORER(x, y, _id, i, "S", _next, 9000 - i)
        if l > 3:
    ...
    if y >= h:
        ...
        i = i - 1
        if s_x != -1:
            return SPORER(x, y, _id, i, "N", _next, 9000 - i)
        if l < -3:
